...
!define setup "ABC123.v01.Setup.exe"
 
; change this to wherever the files to be packaged reside
!define srcdir "."
 
!define company "ABC123"
 
!define prodname "ABC123"
!define unprodname "Uninstall ABC123"
!define exec "ABC123.exe"
...
!ifdef website
WriteINIStr "${startmenu}\www.hackorama.com.url" "InternetShortcut" "URL" ${website}
